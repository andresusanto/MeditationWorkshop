...
$artikel = db_fetch("SELECT * FROM artikel WHERE id ='$opt'");
if ($artikel) {
	$title = $artikel[3];
}else{
	$title = "404";
...
$("#menu2").mouseleave(
  ...
  <td align="center" valign="middle"><img src="<?php echo $sitepath; ?>images/loading.gif" width="16" height="16"/>&nbsp;&nbsp;<b>Loading, Please Wait...</b></td></tr></table>
	...
	<?php 
	if ($artikel) { ?>
		<font size="+1"><?php echo $title; ?></font><small><br/>
		<i>Ditulis oleh <?php echo getUserbyID($artikel[1]); ?> pada <?php echo date("d M Y H:i", $artikel[2]); ?></i></small>
		<br/><br/>
		<?php echo $artikel[4]; ?>
	<?php }else{ ?>
